...
static void ImGui_ImplDX11_CreateWindow(ImGuiViewport* viewport)
{
    ...
    sd.Windowed = TRUE;
    //sd.BufferCount = 1; // 이것도 수정해줘야 한다.
    //sd.SwapEffect = DXGI_SWAP_EFFECT_DISCARD; // 이것도 수정해줘야 한다.

    sd.BufferCount = 2; // 이것도 수정해줘야 한다.
    sd.SwapEffect = DXGI_SWAP_EFFECT_FLIP_DISCARD; // 이것도 수정해줘야 한다.
    sd.Flags = 0;
